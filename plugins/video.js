...
evt.getCMD({pattern: 'btdown360pvideo ?(.*)', fromMe: false, NoListCmd: true}, (async (message, match) => {
...
evt.getCMD({pattern: 'btdown480pvideo ?(.*)', fromMe: false, NoListCmd: true}, (async (message, match) => {
...
evt.getCMD({pattern: 'btdown720pvideo ?(.*)', fromMe: false, NoListCmd: true}, (async (message, match) => {
