...
const DIANA = config.WORKTYPE == 'private' ? true : false
    ...
    evt.getCMD({ pattern: 'animesay ?(.*)', fromMe: QUEEN, desc: Lang.ANIME_DESC }, (async (message, match) => {
    ...
    evt.getCMD({ pattern: 'changesay ?(.*)', fromMe: QUEEN, desc: Lang.CHANGE_DESC }, (async (message, match) => {
    ...
    evt.getCMD({ pattern: 'trumpsay ?(.*)', fromMe: QUEEN, desc: Lang.TRUMP_DESC }, (async (message, match) => {
    ...
    evt.getCMD({ pattern: 'animesay ?(.*)', fromMe: DIANA, desc: Lang.ANIME_DESC }, (async (message, match) => {
    ...
    evt.getCMD({ pattern: 'changesay ?(.*)', fromMe: DIANA, desc: Lang.CHANGE_DESC }, (async (message, match) => {
    ...
    evt.getCMD({ pattern: 'trumpsay ?(.*)', fromMe: DIANA, desc: Lang.TRUMP_DESC }, (async (message, match) => {
