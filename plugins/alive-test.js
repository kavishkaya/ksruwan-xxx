...
evt.getCMD({pattern: 'alive$', fromMe: QUEEN , deleteCommand: false, desc: Lang.ALIVE_DESC}, (async (message, match) => {
...
evt.getCMD({pattern: 'alive$', fromMe: DIANA , deleteCommand: false, desc: Lang.ALIVE_DESC}, (async (message, match) => {
  var alivemsg = config.ALIVEMSG == 'default' ?  "```👋 Hey there, I'm alive now```  \n\n_Version:_ ```v5.0.0``` \n\n _POWERED BY KAVIYAAH_" : config.ALIVEMSG
